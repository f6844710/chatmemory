...
class HistoryArchiver:
    ...
    def __init__(self, api_key: str, model: str = "gpt-4o-mini", archive_length: int = 100,
...
# Memory manager
class ChatMemory:
    def __init__(self, api_key: str = None, model: str = "gpt-4o-mini", history_archiver: HistoryArchiver = None,
